...
for theorems, lemmas, etc. But for presentations, it's arguably more effective just to use a
...
:::{.fragment}
P.S. Regular inline (e.g., $\alpha = 2\pi$) and display math equations work fine too:
